...
## Updating the `/opt` install to v1.4.3
After tagging and pushing `v1.4.3` (`git tag v1.4.3 && git push origin v1.4.3`), rerun the installer so `/opt/blockdag-node-manager` picks up the release:
